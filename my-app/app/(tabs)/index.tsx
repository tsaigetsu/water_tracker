    ...
    return (
      <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
        <View style={styles.container}>
          ...
          <TextInput placeholder="Рост (см)" keyboardType="numeric" style={styles.input} value={height} onChangeText={setHeight} />
          <TextInput placeholder="Вес (кг)" keyboardType="numeric" style={styles.input} value={weight} onChangeText={setWeight} />
            ...
            <View style={styles.modalBackground}>
              <View style={styles.modalContent}>
                ...
                {[100, 200, 300].map(amount => (
                  <Pressable key={amount} onPress={() => handleAddWater(amount)} style={styles.modalButton}>
                    <Text>{amount} мл</Text>
                  </Pressable>
                ))}
                <TextInput
                  placeholder="Свое значение (мл)"
